Shader "Custom/OutlineBlur"
{
	Properties
	{
		_BlurRadius("Blur Radius", Range(0.0,1.0)) = 0.01
		...
		SubShader
		{
			...
			half4 frag(v2f IN) : COLOR
			{
				...
				#define GRABPIXEL(weight, kernaly)  tex2Dproj(_GrabTexture, UNITY_PROJ_COORD(float4(IN.uvgrab.x, IN.uvgrab.y + _GrabTexture_TexelSize.x * kernaly * _BlurRadius, IN.uvgrab.z, IN.uvgrab.w))) * weight
